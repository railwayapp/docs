  ...
  pr_opened:
    ...
    steps:
      - name: Link to project
        run: railway link --project ${{ env.LINK_PROJECT_ID }} --environment ${{ env.DUPLICATE_FROM_ID }} # --workspace ${{ env.WORKSPACE_ID }} # uncomment this if you are linking to a workspace project
