...
New users signing in with your Identity Provider are automatically added to your workspace as [workspace members](/projects/teams#managing-workspaces).
...
1. Add your organization’s email domain(s) as [**Trusted Domains**](/projects/teams#trusted-domains).
