...
A Railway configuration file defines a project and its resources. TypeScript is the documented DSL. Python and Go expose the same helpers and graph; those surfaces are in beta and may change.
