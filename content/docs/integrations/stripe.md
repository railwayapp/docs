...
All services use usage-based pricing with included credits per plan:

| Resource | Rate |
|----------|------|
| Compute (vCPU) | $0.000463/min |
| Memory (GB) | $0.000231/min |
| Volume Storage | $0.25/GB/month |
| Network Egress | $0.10/GB |

Plan subscriptions include monthly credits:
- **Free**: Trial credits (30 days)
- **Hobby**: $5/month included
- **Pro**: $20/seat/month included

For full pricing details, see [Pricing](/reference/pricing).

## Support

- **Help Center**: [help.railway.com](https://help.railway.com)
- **Documentation**: [docs.railway.com](https://docs.railway.com)
- **Status**: [status.railway.com](https://status.railway.com)
- **Terms of Service**: [railway.com/legal/terms](https://railway.com/legal/terms)
- **Privacy Policy**: [railway.com/legal/privacy](https://railway.com/legal/privacy)
- **Acceptable Use**: [railway.com/legal/fair-use](https://railway.com/legal/fair-use)
