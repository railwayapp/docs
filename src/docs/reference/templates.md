...
- Follow the instructions inside the `Earnings` tab. We currently allow withdrawals to Buy Me a Coffee and GitHub Sponsors. After adding your account details you will request a withdrawal. Out team will receive the request and process it right away.
