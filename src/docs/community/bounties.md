---
title: Bounties
description: Learn how to earn Railway credits by helping others in the community.
---

Bounties are a community program where you can earn Railway credits by answering questions in [Central Station](https://station.railway.com). When you help solve another user's problem, you get rewarded.

## How Bounties Work

Bounties are questions from the community that have a credit reward attached. When your answer is accepted as the solution, the bounty amount is added directly to your Railway workspace as credits.

### The Bounty Lifecycle

1. **Question Posted** — A user asks a question in Central Station.
2. **Bounty Created** — Railway marks the question as bounty-eligible and it appears on the [Bounty Board](https://station.railway.com/bounties).
3. **Community Responds** — Anyone can reply with a helpful answer.
4. **Solution Accepted** — The original poster (or a moderator) marks a reply as the accepted solution.
5. **Review & Payout** — Railway reviews the solution and processes the payout.

## Finding Bounties

All active bounties are listed on the [Bounty Board](https://station.railway.com/bounties). You can also opt-in to receive email notifications when new bounties are posted by flipping the "**Subscribe to bounties**" switch on the [Bounty Board](https://station.railway.com/bounties).
...
You can see the bounty amount displayed on each question in the [Bounty Board](https://station.railway.com/bounties).
...
1. Go to the [Bounty Board](https://station.railway.com/bounties) and click to create a new bounty.
...
When your answer is accepted as the solution to a bounty question, you receive the bounty amount as Railway credits.
...
Credits are deposited to your preferred bounty workspace. You can configure this in your Central Station settings. If no preference is set, credits go to your first workspace with a Hobby plan.
...
You can opt-in to receive email notifications whenever a new bounty is posted by flipping the "**Subscribe to bounties**" switch on the [Bounty Board](https://station.railway.com/bounties).
...
- The workspace where the credits were deposited
...
1. Visit the [Bounty Board](https://station.railway.com/bounties) to see open bounties.
2. Find a question you can help with.
3. Post a helpful, detailed answer.
4. If your answer is accepted and verified, you earn the bounty amount in credits.
