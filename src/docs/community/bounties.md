...
You can see the bounty amount displayed on each question in the [Bounty Board](https://station.railway.com/bounties), as well as beneath the initial post when viewing an individual thread.
...
When your answer is accepted as the solution to a bounty question, you receive the bounty amount as earnings. Your bounty earnings appear on your workspace's [Earnings page](https://railway.com/workspace/earnings) alongside any template and referral earnings.
...
Bounty earnings are deposited to your workspace. If you have multiple workspaces, you can choose which one receives your earnings by clicking "Preferred Bounty Workspace" on the [Bounty Board](https://station.railway.com/bounties).
...
Your earnings balance is available on the [Earnings page](https://railway.com/workspace/earnings) and can be applied toward your Railway usage.

### Cash Withdrawals

If you prefer to withdraw your earnings as cash:

1. Go to your workspace's [Earnings page](https://railway.com/workspace/earnings).
