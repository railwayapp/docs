...
Note that project transfers are only allowed for users subscribed to the [Pro Plan](/reference/pricing#plans) (both the initiator and recipient of the transfer).
