...
More about Builds [here](/how-to/configure-builds).
...
More about watch patterns [here](/how-to/configure-builds#configure-watch-paths).
...
More about the build command [here](/how-to/configure-builds#customize-the-build-command)
...
More about the healthcheck path [here]().
...
[Cron schedule](/reference/cron-jobs) to run the deployment on.
