...
- On **January 31st, 2024**:
  ...
  - After your database plugin is shut down, it will be **inaccessible**, and **data will remain intact**
...
- Between **January 31st, 2024** and **Feburary 14th, 2024**:
  ...
  - We will begin **archiving data** of database plugins that were shut down as a result of this deprecation
    ...
    - If your **database plugin is locked, your data will not be archived**. Please **upgrade to a paying plan** to unlock your database plugin and migrate
