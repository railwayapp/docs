...
export const sidebarContent: ISidebarContent = [
  ...
  // Enterprise
  {
    ...
    content: [
      ...
      makePage("Access groups", "enterprise"),
    ...
    content: [
      ...
      makePage("Agent Connectors", "ai"),
      {
        ...
        pages: [
          ...
          makePage("Discord", "ai/agent-integrations"),
        ],
      },
  ...
  },
  {
    ...
    content: [
      ...
      makeCliCommand("postgres"),
      makeCliCommand("project"),
      makeCliCommand("private-network"),
    ...
    content: [
      {
        ...
        pages: [
          ...
          makePage("MongoDB High Availability", "databases", "/databases/mongo-ha"),
  ...
  },
  {
    ...
    content: [
      ...
      makePage("Edge rules", "networking"),
      {
        subTitle: "Troubleshooting",
        pages: [
