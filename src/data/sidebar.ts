...
export const sidebarContent: ISidebarContent = [
  ...
  },
  {
    ...
    content: [
      ...
      makePage("Production Readiness Checklist", "overview", "/reference/production-readiness-checklist"),
    ],
  },
  {
    title: "Platform",
  ...
  },
  {
    ...
    content: [
      ...
      makePage("AWS Marketplace", "pricing", "/reference/pricing/aws-marketplace"),
    ],
  },
  {
    title: "Templates",
  ...
  },
  {
    ...
    content: [
      ...
      makePage("Two-Factor Enforcement", "access", "/reference/two-factor-enforcement"),
  ...
  },
  {
    title: "Services",
    content: [
      makePage("Services", "services"),
    ],
  },
  {
    title: "Variables",
    content: [
      makePage("Variables", "variables"),
    ],
  },
  {
    title: "Deployments",
    content: [
      makePage("Pre-Deploy Command", "deployments", "/guides/pre-deploy-command"),
      ...
      makePage("Image Auto Updates", "deployments", "/guides/image-auto-updates"),
      makePage("Optimize Performance", "deployments", "/guides/optimize-performance"),
  ...
  },
  {
    title: "Cron Jobs",
    content: [
      makePage("Cron Jobs", "cron-jobs"),
    ],
  },
  {
    title: "Functions",
    content: [
      makePage("Functions", "functions", "/reference/functions"),
    ],
  },
  {
    title: "Databases",
    content: [
      ...
      makePage("Build a Database Service", "databases", "/guides/build-a-database-service"),
  ...
  },
  {
    ...
    content: [
      ...
      makePage("Uploading & Serving", "storage-buckets", "/storage-buckets/uploading-serving"),
  ...
  },
  {
    ...
    content: [
      ...
      makePage("Specs & Limits", "public-networking", "/public-networking/specs-and-limits"),
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      makePage("Outbound Networking", "networking", "/reference/outbound-networking"),
      makePage("Static Outbound IPs", "networking", "/reference/static-outbound-ips"),
      makePage("Edge Networking", "networking", "/reference/edge-networking"),
      makePage("Troubleshooting SSL", "networking", "/guides/troubleshooting-ssl"),
    ],
  },
  {
    title: "Observability",
  ...
  },
  {
    title: "Environments",
    content: [
      makePage("Environments", "environments"),
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      makePage("Manage Deployments", "public-api", "/guides/manage-deployments"),
  ...
  },
  {
    ...
    content: [
      ...
      makePage("Application Failed to Respond", "troubleshooting", "/reference/errors/application-failed-to-respond"),
      makePage("No Start Command Could Be Found", "troubleshooting", "/reference/errors/no-start-command-could-be-found"),
      makePage("405 Method Not Allowed", "troubleshooting", "/reference/errors/405-method-not-allowed"),
      makePage("Unable to Generate a Build Plan", "troubleshooting", "/reference/errors/nixpacks-was-unable-to-generate-a-build-plan"),
      makePage("ENOTFOUND redis.railway.internal", "troubleshooting", "/reference/errors/enotfound-redis-railway-internal"),
