  ...
  },
  {
    ...
    configs: {
      ...
      oauth: {
        mode: "oauth",
        description:
          "Run the following. The first tool call prompts you to authenticate:",
        lang: "bash",
      ...
      {config.description ? (
        <p
          ...
          dangerouslySetInnerHTML={{
            __html: renderInlineMarkup(config.description),
          }}
        />
      ) : null}
      {config.button ? (
